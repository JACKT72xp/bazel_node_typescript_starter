...
const generatedConfigShortPath = "app/test__jest.config.mjs";
const bazelSequencerPath = _resolveRunfilesPath(
  "app/_test_bazel_sequencer.cjs"
);
const bazelSnapshotReporterPath = _resolveRunfilesPath(
  "app/_test_bazel_snapshot_reporter.cjs"
);
const bazelSnapshotResolverPath = _resolveRunfilesPath(
  "app/_test_bazel_snapshot_resolver.cjs"
);
