...
export JS_BINARY__TARGET_NAME="main"
export JS_BINARY__TARGET="//app:main"
...
To disable this validation you can set allow_execroot_entry_point_with_no_copy_data_to_bin to True in js_run_binary"
    ...
    entry_point="$JS_BINARY__RUNFILES/_main/app/main.js"
fi
...
export JS_BINARY__NODE_WRAPPER="$JS_BINARY__RUNFILES/_main/app/main_node_bin/node"
