...
#     @aspect_rules_ts~~ext~npm_typescript//:tsc_entrypoint
#
# The script's was generated to execute the js_binary target
#     @aspect_rules_ts~~ext~npm_typescript//:tsc
#
...
export JS_BINARY__BINDIR="bazel-out/darwin_arm64-opt-exec-ST-13d3ddad9198/bin"
...
export JS_BINARY__TARGET_NAME="tsc"
export JS_BINARY__TARGET="@aspect_rules_ts~~ext~npm_typescript//:tsc"
...
To disable this validation you can set allow_execroot_entry_point_with_no_copy_data_to_bin to True in js_run_binary"
    ...
    entry_point="../aspect_rules_ts~~ext~npm_typescript/node_modules/.aspect_rules_js/typescript@5.2.2/node_modules/typescript/bin/tsc"
    if [[ "$entry_point" == ../* ]]; then
        entry_point="external/${entry_point:3}"
    fi
    entry_point="$JS_BINARY__EXECROOT/$BAZEL_BINDIR/$entry_point"
else
    entry_point="$JS_BINARY__RUNFILES/_main/../aspect_rules_ts~~ext~npm_typescript/node_modules/.aspect_rules_js/typescript@5.2.2/node_modules/typescript/bin/tsc"
fi
...
export JS_BINARY__NODE_WRAPPER="$JS_BINARY__RUNFILES/_main/../aspect_rules_ts~~ext~npm_typescript/tsc_node_bin/node"
