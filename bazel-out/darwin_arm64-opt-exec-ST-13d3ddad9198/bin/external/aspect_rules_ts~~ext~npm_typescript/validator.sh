...
#     @aspect_rules_ts~~ext~npm_typescript//:copy_validator
#
# The script's was generated to execute the js_binary target
#     @aspect_rules_ts~~ext~npm_typescript//:validator
#
...
export JS_BINARY__TARGET_NAME="validator"
export JS_BINARY__TARGET="@aspect_rules_ts~~ext~npm_typescript//:validator"
...
To disable this validation you can set allow_execroot_entry_point_with_no_copy_data_to_bin to True in js_run_binary"
    ...
    entry_point="../aspect_rules_ts~~ext~npm_typescript/ts_project_options_validator.js"
    if [[ "$entry_point" == ../* ]]; then
        entry_point="external/${entry_point:3}"
    fi
    entry_point="$JS_BINARY__EXECROOT/$BAZEL_BINDIR/$entry_point"
else
    entry_point="$JS_BINARY__RUNFILES/_main/../aspect_rules_ts~~ext~npm_typescript/ts_project_options_validator.js"
fi
...
export JS_BINARY__NODE_WRAPPER="$JS_BINARY__RUNFILES/_main/../aspect_rules_ts~~ext~npm_typescript/validator_node_bin/node"
