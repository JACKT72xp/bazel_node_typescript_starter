...
export JS_BINARY__BUILD_FILE_PATH="app/BUILD.bazel"
export JS_BINARY__PACKAGE="app"
export JS_BINARY__TARGET_NAME="test"
export JS_BINARY__TARGET="//app:test"
...
export JS_BINARY__NODE_WRAPPER="$JS_BINARY__RUNFILES/_main/app/test_node_bin/node"
...
ARGS=()
ALL_ARGS=(--no-cache --ci --config 'app/test__jest.config.mjs' --colors --runInBand "$@")
