...
const autoConfReporters = !!"1";
const autoConfTestSequencer = !!"1";
const userConfigShortPath = "jest.config.js";
const userConfigPath = "bazel-out/darwin_arm64-fastbuild/bin/jest.config.js";
const generatedConfigShortPath = "common/test__jest.config.mjs";
const bazelSequencerPath = _resolveRunfilesPath(
  "common/_test_bazel_sequencer.cjs"
);
const bazelSnapshotReporterPath = _resolveRunfilesPath(
  "common/_test_bazel_snapshot_reporter.cjs"
);
const bazelSnapshotResolverPath = _resolveRunfilesPath(
  "common/_test_bazel_snapshot_resolver.cjs"
);
